...
class HttpbinUaMiddleware_withoutfakees(object):
...
class HttpbinProxyMiddleware_withoutfakees(object):
    def process_request(self, request, spider):
        appkey = "197016351"
        secret = "1405987d51e35dae7105e0b941b12409"
        paramMap = {
            "app_key": appkey,
